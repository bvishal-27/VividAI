  ...
  if (isUser) return (
    <div className="flex justify-end px-4 md:px-6 bubble-animate">
      <div className="max-w-[85%] md:max-w-[65%] flex flex-col items-end gap-2">
        ...
        {message.pdfName && (
          <div className="flex items-center gap-2 px-3 py-2 rounded-xl bg-red-900/40 border border-red-700/50">
            ...
            <p className="text-xs text-red-300 truncate max-w-[180px]">{message.pdfName}</p>
          </div>
        )}
        {message.content && (
